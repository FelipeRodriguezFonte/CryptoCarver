...
| Carril pagos — resto | Pendiente: **Thales Key Block** (esquema S), Atalla AKB, Futurex MFK, SafeNet KM, ISO 8583, secure messaging por esquema, MAC ISO 9797-1 algoritmos 2/4/6, PIN blocks heredados, banco de comandos host de HSM, HCE y tokenización, y el menudeo genérico. FPE se hizo por otra vía. |
