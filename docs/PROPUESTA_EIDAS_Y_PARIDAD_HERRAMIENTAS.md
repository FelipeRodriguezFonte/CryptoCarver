...
| 8 | **HCE y tokenización**: Visa LUK/MSD/qVSDC, Mastercard CVC3/PIN-CVC3 y DS, ICC Dynamic Number, CAP y AMEX CSC | **Parcial**: `VisaHceOperations` (`VisaHceOperationsTest`) cubre LUK, MSD y qVSDC; `MastercardDataStorage` (`MastercardDataStorageTest`) cubre DSPK, Digest y Summary. CVC3 y PIN-CVC3 permanecen aparcados porque la herramienta externa ignora UN y ATC. Las capturas del 26-09-2026 (`docs/CAPTURAS_CALCULADORA_HCE.md` §6) muestran resultados finales de AMEX CSC v1 e ICC Dynamic Number, pero no los intermedios necesarios para implementar sus algoritmos; AMEX CSC v2 lanza una excepción y la pantalla CAP no tiene las entradas del vector solicitado. Por ello no hay clase ni test nuevos para estas operaciones. |
