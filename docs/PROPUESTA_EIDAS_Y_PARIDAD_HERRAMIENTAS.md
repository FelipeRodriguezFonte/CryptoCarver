...
| 6 | **PIN blocks heredados**: Docutel, Diebold, Plus, ECI 1-4, Visa 1-4, Europay/Banksys y AS2805 8.1 (la herramienta externa soporta 19+) | `PaymentOperations` y `PinBlockFormat` cubren ISO 0/1/2/3/4, IBM 3624, ECI 2/3, Visa 1/2/3, Docutel, Diebold y Plus. ECI-1, ECI-4 y VISA-4 mantienen equivalencias no verificadas. Europay/Banksys y AS2805 8.1 siguen pendientes de estructura pública verificable; ver `CAPTURAS_PIN_BLOCKS_HEREDADOS.md` |
