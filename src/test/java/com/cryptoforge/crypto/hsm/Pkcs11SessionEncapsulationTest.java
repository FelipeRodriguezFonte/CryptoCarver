...
public class Pkcs11SessionEncapsulationTest {
    ...
    public void testSoftHsmUpdateCertificateChain() throws Exception {
        ...
        for (String part : pemCerts) {
            ...
            if (endIndex != -1) {
                originalChain.add(com.cryptoforge.crypto.CertificateGenerator.parseCertificate(pem.substring(0, endIndex + 25)));
            }
        }
        ...
        java.security.KeyPair wrongPair = com.cryptoforge.crypto.AsymmetricKeyOperations.generateRSAKeyPair(2048);
        com.cryptoforge.crypto.CertificateGenerator.CertificateConfig wrongConfig = new com.cryptoforge.crypto.CertificateGenerator.CertificateConfig();
        wrongConfig.commonName = "Mismatch Key Test";
        X509Certificate wrongCert = com.cryptoforge.crypto.CertificateGenerator.generateSelfSignedCertificate(wrongPair, wrongConfig);
