...
public class SoftHsmIntegrationTest {
    ...
    public void testXAdESPkcs11Signature() throws Exception {
        ...
        String signedXml = com.cryptocarver.crypto.XMLSignatureOperations.signXAdESWithPkcs11(
        ...
        com.cryptocarver.crypto.XMLSignatureOperations.VerificationResult result =
                com.cryptocarver.crypto.XMLSignatureOperations.verifyXAdES(signedXml);
        ...
        com.cryptocarver.crypto.XMLSignatureOperations.VerificationResult failResult =
                com.cryptocarver.crypto.XMLSignatureOperations.verifyXAdES(alteredXml);
    ...
    public void testCmsSignature() throws Exception {
        ...
        com.cryptocarver.crypto.CMSOperations.VerificationResult result = com.cryptocarver.crypto.CMSOperations.verifySignedData(cmsSignature, (java.security.cert.X509Certificate) certChain[0]);
    ...
    public void testCmsEncryption() throws Exception {
        ...
        byte[] encryptedData = com.cryptocarver.crypto.CMSOperations.generateEnvelopedData(data, (java.security.cert.X509Certificate) certChain[0]);
    ...
    public void testPadesSignature() throws Exception {
        ...
        com.cryptocarver.crypto.PadesOperations.PdfSignatureInspection inspection =
                com.cryptocarver.crypto.PadesOperations.inspectSignatures(signedPdf);
    ...
    public void testAsicSSignature() throws Exception {
        ...
        com.cryptocarver.crypto.AsicOperations.AsicInspection inspection =
                com.cryptocarver.crypto.AsicOperations.inspectAndVerify(container);
    ...
    public void testAsicESignature() throws Exception {
        ...
        com.cryptocarver.crypto.AsicOperations.AsicEInspection inspection =
                com.cryptocarver.crypto.AsicOperations.inspectAndVerifyE(container);
