...
class TrustedEntityListJsonInspectorTest {
    private static final String LIST = """
      {"LoTE":{"ListAndSchemeInformation":{"LoTEVersionIdentifier":1,"LoTESequenceNumber":7,"SchemeOperatorName":[{"lang":"en","value":"Example authority"}],"ListIssueDateTime":"2025-11-01T00:00:00Z","NextUpdate":"2025-12-01T00:00:00Z"},"TrustedEntitiesList":[{"TrustedEntityInformation":{"TEName":[{"lang":"en","value":"Example provider"}]},"TrustedEntityServices":[{"ServiceInformation":{"ServiceName":[{"lang":"en","value":"Wallet service"}],"ServiceDigitalIdentity":[{}],"ServiceTypeIdentifier":"https://example.test/type","ServiceStatus":"https://example.test/granted","StatusStartingTime":"2025-11-01T00:00:00Z","ServiceInformationExtensions":[{"qualifier":"example"}]}}]}]}}""";
