...
class TsaAuthDataLoaderTest {
    ...
    void testAppSettingsDoesNotPersistCredentials() throws Exception {
        ...
        java.lang.reflect.Constructor<com.cryptocarver.model.AppSettings> constructor = com.cryptocarver.model.AppSettings.class.getDeclaredConstructor();
        constructor.setAccessible(true);
        com.cryptocarver.model.AppSettings settings = constructor.newInstance();

        java.nio.file.Path tempSettingsFile = java.nio.file.Files.createTempFile("cryptoforge_test_settings", ".json");
        java.lang.reflect.Field fileField = com.cryptocarver.model.AppSettings.class.getDeclaredField("file");
        fileField.setAccessible(true);
        fileField.set(settings, tempSettingsFile);

        settings.saveTsaProfile("TestTSA", "http://example.com");

        java.util.List<com.cryptocarver.model.AppSettings.TsaProfile> profiles = settings.getTsaProfiles();
