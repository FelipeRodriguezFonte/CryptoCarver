...
class ASN1ControllerTest {
    ...
    void setUp() throws Exception {
        ...
        mockReporter = new StatusReporter() {
            ...
            @Override public void updateInspector(String s, byte[] b1, byte[] b2, java.util.List<com.cryptocarver.model.OperationDetail> d) {}
            @Override public void addToHistory(String s, java.util.List<com.cryptocarver.model.OperationDetail> d) {}
