...
public class KeyCertificateWorkbenchUIFlowTest {
    ...
    public void setupController() throws Exception {
        ...
        controller.setStatusReporter(new com.cryptocarver.ui.StatusReporter() {
            ...
            public void updateInspector(String title, byte[] source, byte[] target, java.util.List<com.cryptocarver.model.OperationDetail> details) {}
