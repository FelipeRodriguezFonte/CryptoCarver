...
import com.cryptoforge.crypto.PadesOperations;
...
public final class PadesController {
    ...
    private void handleLoadTokenKeys() {
        try {
            java.util.List<String> aliases = com.cryptoforge.crypto.hsm.Pkcs11SessionManager.getInstance()
    ...
    private void handleSign() {
        ...
        try {
            ...
            if (tokenSource) {
                ...
                signed = com.cryptoforge.crypto.hsm.Pkcs11SessionManager.getInstance().requireSession()
