...
import com.cryptoforge.crypto.AsicOperations;
...
public final class AsicController {
    ...
    private void handleLoadTokenKeys() {
        try {
            List<String> aliases = com.cryptoforge.crypto.hsm.Pkcs11SessionManager.getInstance()
    ...
    private void handleCreate() {
        ...
        try {
            ...
            byte[] container;
            if (tokenSource) {
                container = com.cryptoforge.crypto.hsm.Pkcs11SessionManager.getInstance().requireSession()
