...
public class MACOperations {
    ...
    public static byte[] generate(byte[] data, byte[] key, String algorithm) throws Exception {
        return generate(data, key, algorithm, com.cryptocarver.util.ProgressMonitor.NO_OP);
    }

    public static byte[] generate(byte[] data, byte[] key, String algorithm, com.cryptocarver.util.ProgressMonitor monitor) throws Exception {
    ...
    public static byte[] generate(java.nio.file.Path file, byte[] key, String algorithm) throws Exception {
        return generate(file, key, algorithm, com.cryptocarver.util.ProgressMonitor.NO_OP);
    }

    /**
     * Generate MAC for a file via streaming with progress monitoring
     */
    public static byte[] generate(java.nio.file.Path file, byte[] key, String algorithm, com.cryptocarver.util.ProgressMonitor monitor) throws Exception {
        if (monitor == null) monitor = com.cryptocarver.util.ProgressMonitor.NO_OP;
        validateKeySize(key, algorithm);
