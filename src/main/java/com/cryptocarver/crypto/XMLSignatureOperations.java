...
import com.cryptocarver.crypto.hsm.Pkcs11SessionManager;
...
public class XMLSignatureOperations {
    ...
    public static String signXAdESWithPkcs11(String xmlContent, String alias, String level, String tsaUrl,
                                             String packaging, com.cryptocarver.model.TsaAuthCredentials auth) throws Exception {
        return Pkcs11SessionManager.getInstance().requireSession()
                .signXAdES(xmlContent, alias, level, tsaUrl, packaging, auth);
    }

    /**
     * Internal DSS bridge used only by {@link com.cryptocarver.crypto.hsm.Pkcs11Session}.
