...
public class ModernMainController implements StatusReporter, OperationNavigator {
    ...
    private void handleInspectKeyMaterial() {
        ...
        details.add(privateMaterial
                ? com.cryptocarver.model.OperationDetail.secretDetail("Input material", "Private key metadata inspected")
                : com.cryptocarver.model.OperationDetail.publicDetail("Input material", "Public key or certificate metadata inspected"));
        details.add(com.cryptocarver.model.OperationDetail.publicDetail("Report", "Key material inspection completed", true, "text/plain"));
        ...
        publish(com.cryptocarver.model.OperationResult.forOperation("Key Material Inspector")
    ...
    private void handleEncodeASN1() {
        try {
            ...
            if (encoded != null) {
                ...
                publish(com.cryptocarver.model.OperationResult.forOperation("ASN.1 Encode")
    ...
    private void updateInspector(String operation, byte[] input, byte[] output) {
        updateInspector(operation, input, output, (java.util.List<com.cryptocarver.model.OperationDetail>) null);
    }
    ...
    public void updateInspector(String operation, byte[] input, byte[] output, java.util.List<com.cryptocarver.model.OperationDetail> details) {
        ...
        if (inspectorDetailsContainer != null) {
            ...
            if (details != null && !details.isEmpty()) {
                for (com.cryptocarver.model.OperationDetail detail : details) {
    ...
    private TableView<com.cryptocarver.model.HistoryItem> historyTable;
    ...
    private void showLegacyHistoryView() {
        ...
        if (mainHistoryContainer == null) {
            ...
            ComboBox<com.cryptocarver.model.SecretVisibility> visibilityCombo = new ComboBox<>();
            visibilityCombo.getItems().setAll(com.cryptocarver.model.SecretVisibility.values());
            visibilityCombo.setValue(com.cryptocarver.model.AppSettings.getInstance().getSecretVisibility());
            visibilityCombo.setOnAction(e -> {
                com.cryptocarver.model.AppSettings.getInstance().setSecretVisibility(visibilityCombo.getValue());
            });
            ...
            TableColumn<com.cryptocarver.model.HistoryItem, String> timeCol = new TableColumn<>("Time");
            timeCol.setCellValueFactory(
                    data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getTimestamp()));

            TableColumn<com.cryptocarver.model.HistoryItem, String> opCol = new TableColumn<>("Operation");
            opCol.setCellValueFactory(
                    data -> new javafx.beans.property.SimpleStringProperty(data.getValue().getOperation()));

            TableColumn<com.cryptocarver.model.HistoryItem, String> actionCol = new TableColumn<>("Action");
            actionCol.setCellFactory(col -> new TableCell<>() {
                private final Button btn = new Button("Rerun");
                {
                    ...
                    btn.setOnAction(event -> {
                        com.cryptocarver.model.HistoryItem item = getTableView().getItems().get(getIndex());
                        restoreUIState(item.getUiState());
                        updateStatus("Restored state for: " + item.getOperation());
                        handleItemSelected(item.getOperation());
                    });
            ...
            TableView<com.cryptocarver.model.OperationDetail> detailsTable = new TableView<>();
            ...
            TableColumn<com.cryptocarver.model.OperationDetail, String> nameCol = new TableColumn<>("Property");
            nameCol.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(data.getValue().name()));

            TableColumn<com.cryptocarver.model.OperationDetail, String> valCol = new TableColumn<>("Value");
            valCol.setCellValueFactory(data -> new javafx.beans.property.SimpleStringProperty(data.getValue().value()));

            TableColumn<com.cryptocarver.model.OperationDetail, String> classCol = new TableColumn<>("Class");
            ...
            historyTable.getSelectionModel().selectedItemProperty().addListener((obs, oldVal, newVal) -> {
                if (newVal != null && newVal.getStructuredDetails() != null) {
                    ...
                    detailsTable.getItems().add(com.cryptocarver.model.OperationDetail.publicDetail("Raw JSON", newVal.getDetails()));
                } else {
                    detailsTable.getItems().clear();
                }
            });
    ...
    private void exportSelectedHistoryRecipe() {
        ...
        com.cryptocarver.model.HistoryItem item = historyTable.getSelectionModel().getSelectedItem();
        com.cryptocarver.model.OperationRecipe recipe;
        if (item.getStructuredDetails() != null && !item.getStructuredDetails().isEmpty()) {
            recipe = new com.cryptocarver.model.OperationRecipe(
                item.getOperation(),
    ...
    private void handleCompareHistory() {
        java.util.List<com.cryptocarver.model.HistoryItem> selected = historyTable.getSelectionModel().getSelectedItems();
        if (selected == null || selected.size() != 2) return;

        java.util.List<com.cryptocarver.utils.HistoryComparator.DiffEntry> diffs = com.cryptocarver.utils.HistoryComparator.compare(selected.get(0), selected.get(1));

        TableView<com.cryptocarver.utils.HistoryComparator.DiffEntry> diffTable = new TableView<>();
        diffTable.setColumnResizePolicy(TableView.CONSTRAINED_RESIZE_POLICY);
        attachTableViewerSupport(diffTable);

        TableColumn<com.cryptocarver.utils.HistoryComparator.DiffEntry, String> keyCol = new TableColumn<>("Property");
        keyCol.setCellValueFactory(d -> new javafx.beans.property.SimpleStringProperty(d.getValue().key));

        TableColumn<com.cryptocarver.utils.HistoryComparator.DiffEntry, String> val1Col = new TableColumn<>("Item 1\n" + selected.get(0).getTimestamp());
        val1Col.setCellValueFactory(d -> new javafx.beans.property.SimpleStringProperty(d.getValue().value1));

        TableColumn<com.cryptocarver.utils.HistoryComparator.DiffEntry, String> val2Col = new TableColumn<>("Item 2\n" + selected.get(1).getTimestamp());
        ...
        diffTable.setRowFactory(tv -> new javafx.scene.control.TableRow<com.cryptocarver.utils.HistoryComparator.DiffEntry>() {
            @Override
            protected void updateItem(com.cryptocarver.utils.HistoryComparator.DiffEntry item, boolean empty) {
                super.updateItem(item, empty);
                if (item == null || empty) {
                    setStyle("");
    ...
    private void importOperationRecipe() {
        ...
        try {
            com.cryptocarver.model.OperationRecipe recipe = com.cryptocarver.model.OperationRecipe.fromJson(
            ...
            recipe.parameters().values().forEach(value -> variableNames.addAll(
                    com.cryptocarver.model.RecipeVariables.referencedVariables(value)));
            ...
            recipe.parameters().forEach((key, value) -> resolvedParameters.put(key,
                    com.cryptocarver.model.RecipeVariables.resolve(value, variables)));
    ...
    String renderPublishedResult(com.cryptocarver.model.OperationResult result, com.cryptocarver.model.SecretVisibility visibility) {
        ...
        com.cryptocarver.model.OperationDetail.Classification overall = com.cryptocarver.model.OperationDetail.Classification.PUBLIC;
        for (com.cryptocarver.model.OperationDetail detail : result.getDetails()) {
            if (detail == null) continue;
            if (detail.classification() == com.cryptocarver.model.OperationDetail.Classification.SECRET) {
                overall = com.cryptocarver.model.OperationDetail.Classification.SECRET;
                break;
            }
            if (detail.classification() == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE) {
                overall = com.cryptocarver.model.OperationDetail.Classification.SENSITIVE;
            }
        }

        if (overall == com.cryptocarver.model.OperationDetail.Classification.SECRET) {
        ...
        } else if (overall == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE) {
            if (visibility != com.cryptocarver.model.SecretVisibility.FULL_LAB) return "***MASKED***";
        }

        if (result.getEnrichedOutput() != null && !result.getEnrichedOutput().isBlank()) {
            com.cryptocarver.model.OperationDetail.Classification cls = result.getEnrichedOutputClassification();
            if (cls == com.cryptocarver.model.OperationDetail.Classification.SECRET) {
                if (visibility == com.cryptocarver.model.SecretVisibility.REDACTED) return "";
                if (visibility == com.cryptocarver.model.SecretVisibility.MASKED) return "***MASKED***";
            } else if (cls == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE) {
                if (visibility != com.cryptocarver.model.SecretVisibility.FULL_LAB) return "***MASKED***";
            }
        ...
        com.cryptocarver.model.OperationDetail.Classification outCls = result.getOutputClassification();
        if (outCls == com.cryptocarver.model.OperationDetail.Classification.SECRET) {
            if (visibility == com.cryptocarver.model.SecretVisibility.REDACTED) return "";
            if (visibility == com.cryptocarver.model.SecretVisibility.MASKED) return "***MASKED***";
        } else if (outCls == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE) {
            if (visibility != com.cryptocarver.model.SecretVisibility.FULL_LAB) return "***MASKED***";
        }
    ...
    private String formatPublishedSummary(com.cryptocarver.model.OperationResult result) {
        ...
        com.cryptocarver.model.SecretVisibility visibility = com.cryptocarver.model.AppSettings.getInstance()
                .getSecretVisibility();
        for (com.cryptocarver.model.OperationDetail detail : result.getDetails()) {
            if (detail == null || (detail.classification() == com.cryptocarver.model.OperationDetail.Classification.SECRET
                    && visibility == com.cryptocarver.model.SecretVisibility.REDACTED)) {
                continue;
            }
            String value = detail.value();
            if (detail.classification() == com.cryptocarver.model.OperationDetail.Classification.SECRET
                    && visibility == com.cryptocarver.model.SecretVisibility.MASKED) {
                value = "***MASKED***";
            } else if (detail.classification() == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE
    ...
    public com.cryptocarver.model.OperationDetail.Classification classifyPublishedResult(com.cryptocarver.model.OperationResult result) {
        if (result == null) return com.cryptocarver.model.OperationDetail.Classification.PUBLIC;

        com.cryptocarver.model.OperationDetail.Classification maxCls = com.cryptocarver.model.OperationDetail.Classification.PUBLIC;

        if (result.getOutputClassification() == com.cryptocarver.model.OperationDetail.Classification.SECRET ||
            result.getEnrichedOutputClassification() == com.cryptocarver.model.OperationDetail.Classification.SECRET) {
            return com.cryptocarver.model.OperationDetail.Classification.SECRET;
        }

        if (result.getOutputClassification() == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE ||
            result.getEnrichedOutputClassification() == com.cryptocarver.model.OperationDetail.Classification.SENSITIVE) {
            maxCls = com.cryptocarver.model.OperationDetail.Classification.SENSITIVE;
        }
