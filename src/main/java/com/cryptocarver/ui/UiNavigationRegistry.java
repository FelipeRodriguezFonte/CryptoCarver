...
public final class UiNavigationRegistry {
    ...
    private static Map<String, Route> buildRoutes() {
        ...
        add(routes, new Route(Module.WALLET, null),
                ...
                "Trusted List", "Trusted Entity List JSON", "CBOR Inspector", "SCA / OpenID4VP", "AdES Validation");
        ...
        add(routes, new Route(Module.KEYS_SYMMETRIC, "ICSF / CCA Key Export / Import"),
                "ICSF / CCA Key Export / Import", "ICSF Key Export", "ICSF Key Import",
                "ICSF Export", "ICSF Import");
