...
public final class ModuleTextCatalog {
    ...
    public static Map<String, String> keys() {
        ...
        map.put("Key Block LMK (optional, to unwrap the key):",
                "module.keys.keyBlock.lmk");
        map.put("Unwrap Key Block",
                "module.keys.keyBlock.unwrap");
    ...
    public static Map<String, String> generic() {
        ...
        map.put("Bit shift:", "module.generic.bitShift");
        map.put("Shift left", "module.generic.shiftLeft");
        map.put("Shift right", "module.generic.shiftRight");
        map.put("Extract trace hex", "module.generic.extractTraceHex");
    ...
    public static Map<String, String> payments() {
        ...
        map.put("🖥 payShield Host Command Bank", "module.payments.hsmHost.title");
        map.put("Compose and inspect host frames locally. The bank never opens a socket. Command bodies remain opaque unless their field layout has been verified from a primary manual or an external vector.", "module.payments.hsmHost.help");
        map.put("Message header:", "module.payments.hsmHost.header");
        map.put("Command code:", "module.payments.hsmHost.commandCode");
        map.put("Command body:", "module.payments.hsmHost.body");
        map.put("Message trailer (optional):", "module.payments.hsmHost.trailer");
        map.put("Header length for analysis:", "module.payments.hsmHost.headerLength");
        map.put("Two-byte TCP length prefix", "module.payments.hsmHost.tcpPrefix");
        map.put("Captured frame:", "module.payments.hsmHost.capturedFrame");
        map.put("Compose Command", "module.payments.hsmHost.compose");
        map.put("Analyze Command", "module.payments.hsmHost.analyzeCommand");
        map.put("Analyze Response", "module.payments.hsmHost.analyzeResponse");
        map.put("Load NC Example", "module.payments.hsmHost.loadExample");
        map.put("ISO 8583 Message Inspector", "module.payments.iso8583.title");
        map.put("Parse and build ISO 8583 messages with version-aware field dictionaries, bitmap and length encoding.", "module.payments.iso8583.help");
        map.put("Build input: one MTI line followed by field=value lines (for example, 3=000000).", "module.payments.iso8583.buildHelp");
        map.put("Profile:", "module.payments.iso8583.profile");
        map.put("Bitmap encoding:", "module.payments.iso8583.bitmapEncoding");
        map.put("Length encoding:", "module.payments.iso8583.lengthEncoding");
        map.put("Message, or build definition (MTI then one field=value per line):", "module.payments.iso8583.message");
        map.put("0200\n3=000000\n11=123456", "module.payments.iso8583.messagePrompt");
        map.put("Parse message", "module.payments.iso8583.parse");
        map.put("Build message", "module.payments.iso8583.build");
        map.put("Report:", "module.payments.iso8583.report");
        map.put("The field-by-field report will appear here...", "module.payments.iso8583.reportPrompt");
        map.put("No ISO 8583 message was provided.", "module.payments.iso8583.emptyMessage");
        map.put("ISO 8583 {0} completed.", "module.payments.iso8583.completed");
        map.put("ISO 8583 operation failed: {0}", "module.payments.iso8583.error");
    ...
    public static Map<String, String> emv() {
        ...
        map.put("📱 Visa HCE", "module.emv.hce.title");
        map.put("Derive a limited-use key, then calculate MSD and qVSDC values. Each result remains editable in the next step.", "module.emv.hce.help");
        map.put("1. Limited-use key (LUK)", "module.emv.hce.step1");
        map.put("2. MSD verification value", "module.emv.hce.step2");
        map.put("3. qVSDC cryptogram", "module.emv.hce.step3");
        map.put("UDK:", "module.emv.hce.udk");
        map.put("Year:", "module.emv.hce.year");
        map.put("Hours since January 1:", "module.emv.hce.hours");
        map.put("Hourly counter:", "module.emv.hce.counter");
        map.put("LUK:", "module.emv.hce.luk");
        map.put("ATC:", "module.emv.hce.atc");
        map.put("Device type:", "module.emv.hce.deviceType");
        map.put("9F02 Amount:", "module.emv.hce.amount");
        map.put("9F03 Other amount:", "module.emv.hce.otherAmount");
        map.put("9F1A Terminal country:", "module.emv.hce.country");
        map.put("95 TVR:", "module.emv.hce.tvr");
        map.put("5F2A Transaction currency:", "module.emv.hce.currency");
        map.put("9A Transaction date:", "module.emv.hce.date");
        map.put("9C Transaction type:", "module.emv.hce.type");
        map.put("9F37 Unpredictable number:", "module.emv.hce.un");
        map.put("82 AIP:", "module.emv.hce.aip");
        map.put("CVR:", "module.emv.hce.cvr");
        map.put("Terminal data", "module.emv.hce.terminal");
        map.put("Chip data", "module.emv.hce.chip");
        map.put("Derive LUK", "module.emv.hce.lukAction");
        map.put("Calculate MSD", "module.emv.hce.msdAction");
        map.put("Calculate qVSDC", "module.emv.hce.qvsdcAction");
        map.put("16 bytes of card key in hex", "module.emv.hce.prompt.udk");
        map.put("1 or 2 decimal digits", "module.emv.hce.prompt.year");
        map.put("4 decimal digits", "module.emv.hce.prompt.hours");
        map.put("2 decimal digits", "module.emv.hce.prompt.counter");
        map.put("16-byte LUK in hex; filled by step 1", "module.emv.hce.prompt.luk");
        map.put("2 bytes in hex", "module.emv.hce.prompt.atc");
        map.put("8 bytes in hex", "module.emv.hce.prompt.deviceType");
        map.put("6 bytes in hex", "module.emv.hce.prompt.amount");
        map.put("6 bytes in hex (other amount)", "module.emv.hce.prompt.otherAmount");
        map.put("2 bytes in hex (country)", "module.emv.hce.prompt.country");
        map.put("5 bytes in hex", "module.emv.hce.prompt.tvr");
        map.put("2 bytes in hex (currency)", "module.emv.hce.prompt.currency");
        map.put("3 bytes in hex", "module.emv.hce.prompt.date");
        map.put("1 byte in hex", "module.emv.hce.prompt.type");
        map.put("4 bytes in hex", "module.emv.hce.prompt.un");
        ...
        map.put("ICC Dynamic Number", "module.emv.iccDn.title");
        ...
        map.put("DS input:", "module.emv.ds.input");
        map.put("Derive DSPK", "module.emv.ds.dspkAction");
        map.put("Calculate digest", "module.emv.ds.digestAction");
        map.put("At least 6 bytes in hex", "module.emv.ds.prompt.id");
        map.put("8-byte operator ID in hex", "module.emv.ds.prompt.operatorId");
        map.put("8-byte DS input in hex", "module.emv.ds.prompt.input");
