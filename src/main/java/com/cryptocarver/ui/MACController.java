...
public class MACController {
    ...
    public void handleGenerateMAC() {
        try {
            ...
            if (mainController != null) {
                mainController.publish(com.cryptocarver.model.OperationResult.forOperation("Generate MAC - " + algorithm)
                    .details(java.util.List.of(
                        new com.cryptocarver.model.OperationDetail("Input Parameters", "Data: " + data.length + " bytes, Key: " + (key.length * 8) + " bits", com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null),
                        new com.cryptocarver.model.OperationDetail("Output", "MAC: " + finalMac.length + " bytes" + truncationInfo, com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null)
                    ))
                    .build());
            }
    ...
    public void handleVerifyMAC() {
        try {
            ...
            // Add to history
            if (mainController != null) {
                mainController.publish(com.cryptocarver.model.OperationResult.forOperation("Verify MAC - " + algorithm)
                    .details(java.util.List.of(
                        new com.cryptocarver.model.OperationDetail("Input Parameters", "MAC: " + mac.length + " bytes, Key: " + (key.length * 8) + " bits", com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null),
                        new com.cryptocarver.model.OperationDetail("Output", "Result: " + (valid ? "VALID ✓" : "INVALID ✗"), com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null)
                    ))
                    .build());
            }
