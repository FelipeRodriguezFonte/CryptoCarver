...
public class SignatureController {
    ...
    public void handleSign() {
        try {
            ...
            if (mainController != null) {
                mainController.publish(com.cryptocarver.model.OperationResult.forOperation("Sign - " + algorithm)
                    .details(java.util.List.of(
                        new com.cryptocarver.model.OperationDetail("Input Parameters", "Data: " + data.length + " bytes", com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null),
                        new com.cryptocarver.model.OperationDetail("Output", "Signature: " + signature.length + " bytes", com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null)
                    ))
                    .build());
            }
    ...
    public void handleVerify() {
        try {
            ...
            // Add to history
            if (mainController != null) {
                mainController.publish(com.cryptocarver.model.OperationResult.forOperation("Verify - " + algorithm)
                    .details(java.util.List.of(
                        new com.cryptocarver.model.OperationDetail("Input Parameters", "Signature: " + signature.length + " bytes", com.cryptocarver.model.OperationDetail.Classification.SECRET, false, null),
