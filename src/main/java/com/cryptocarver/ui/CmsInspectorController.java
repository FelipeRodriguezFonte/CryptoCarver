...
import com.cryptocarver.crypto.CmsInspector;
...
public class CmsInspectorController {
    ...
    private com.cryptocarver.crypto.CmsInspectionReport currentReport;
        ...
        try {
            ...
            if (statusReporter != null) {
                OperationResult result = OperationResult.forOperation("CMS_INSPECTOR")
                    ...
                    .status(t("module.cms.feedback.statusInspected", report.getType(), report.getContentState()))
                    .build();
